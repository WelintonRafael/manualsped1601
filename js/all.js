...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Manual para Registro 1601 do SPED. ICMS/IPI","1. 1. Ajustes dos Cadastros.","2. 2.Operações de Vendas","3. 3. Gerar SPED ICMS/IPI","1.1. 1.1. Cadastro de Cartão de Crédito/Débito.","1.2. 1.2. Cadastro de PIX.","1.3. 1.3 Cadastro Origem da Venda(Intermediador)","2.1. 2.1 - Vendas Recebimento de Cartão Crédito /Débito.","2.2. 2.2 - Vendas Recebimento  por PIX.","2.3. 2.3- Vendas com Intermediador.","3.1. Editar os valores gerados pelas receitas ou incluir valor de recebimentos."],
    DREX_NODE_LINKS: ["index.htm","1__ajustes_dos_cadastros_.htm","2_operacoes_de_vendas.htm","3__gerar_sped_icms_ipi.htm","1_1__cadastro_de_cartao_de_credito_debito_.htm","1_2__cadastro_de_pix_.htm","1_3_cadastro_origem_da_venda_intermediador_.htm","2_1___vendas_recebimento_de_cartao_credito__debito_.htm","2_2___vendas_recebimento__por_pix_.htm","2_3__vendas_com_intermediador_.htm","editar_os_valores_gerados_pelas_receitas_ou_incluir_valor_de_recebimentos_.htm"],
    DREX_NODE_CHILD_START: [1,4,7,10,11,11,11,11,11,11,11],
    DREX_NODE_CHILD_END: [4,7,10,11,11,11,11,11,11,11,11],
    DREX_MENU_TYPE: 2,
